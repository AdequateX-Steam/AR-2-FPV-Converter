...
//////////////////////////////////////////////// MODULES //////////////////////////////////////////////
	...
	class EXP_CuratorWarhead_F : EXP_ModuleTemplate_F
	{
		...
		class Attributes: AttributesBase 
		{
			...
			{
				displayName = "Warhead Type:";			
				tooltip = "Choose which warhead to arm the drones with";	
				property = "EXP_ModuleDefence_WarheadSelector";				
		...
		class ModuleDescription : ModuleDescription
		{
			...
			displayName = "";
			duplicate = 0;
			duplicateDisabled = "No entities can be synced";
			duplicateEnabled = "Multiple entities of this type can be synced.";
			icon = "";
			position = 1;
			positionDisabled = "Has no effect";
			positionEnabled = "location of module affects drone spawn position";
			sync[] = {}; //All
			vehicle[] = {};		
		};
	};
