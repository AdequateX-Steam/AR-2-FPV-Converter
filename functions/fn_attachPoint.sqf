...
switch (_warheadType) do 
{
	...
	case "fpvGrenade":{_posArray = [0,0.325,0.07]};
	case "R_MRAAWS_HEAT_F":{_posArray = [0,0.05,-0.11]};
	case "R_MRAAWS_HE_F":{_posArray = [0,0.175,-0.13]};
	case "R_MRAAWS_HEAT55_F":{_posArray = [0,0.15,-0.13]};
	case "M_NLAW_AT_F":{_posArray = [0,0.075,-0.155]};
	case "R_PG32V_F":{_posArray = [0,-0.075,-0.155]};
	case "R_TBG32V_F":{_posArray = [0,0.1,-0.155]};
	case "R_PG7_F":{_posArray = [0,-0.065,-0.13]};
	case "M_Vorona_HEAT":{_posArray = [0,-0.5,-0.17]};
	case "M_Vorona_HE":{_posArray = [0,-0.5,-0.17]};
	...
	case "ATMine_Range_Ammo":{_posArray = [0,0.25,.135]};
	case "M_Titan_AA":{_posArray = [0,-0.6,-0.17]};
	case "M_Titan_AP":{_posArray = [0,-0.3,-0.17]};
